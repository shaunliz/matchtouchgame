...
public class StageSelectFace extends Activity
{
...
//    public static AdRequest                         adRequest;
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        loadStage();
        cleared_stage_after_calc = cleared_stage - StaticInfo.STAGE_SIZE_EACH * 3;
        ...
        setContentView(R.layout.stageselectface);
...
//        adView.loadAd(adRequest);
    ...
    private void updateClearedStages()
    {
        ...
        for(int i = 0; i < cleared_stage_after_calc; i++)
        {
            ...
            imageView[i] = (ImageView)findViewById(R.id.stage_121 + i * 5);
            imageView[i].setImageResource(R.drawable.btn_stage_select_numeric_each);
            
            textViewStage[i] = (TextView)findViewById(R.id.stage_text_121 + i * 5);
            textViewStage[i].setVisibility(View.VISIBLE);
            
            // display each stages score and time.
            textViewScore[i] = (TextView)findViewById(R.id.stage_score_121 + i * 5);
            textViewSec[i] = (TextView)findViewById(R.id.stage_sec_121 + i * 5);
            
            cur  = db.query("score", PROJECTION, "stage = " + "" + (i + 1 + (StaticInfo.STAGE_SIZE_EACH * 3)), null, null, null, null);
            ...
            imageView[i].setOnClickListener(new View.OnClickListener()
            {
                ...
                public void onClick(View v)
                {
                    ...
                    {
                        if((R.id.stage_121 + nStage * 5) == v.getId())
                        {
                            requested_stage = nStage + StaticInfo.STAGE_SIZE_NUMERIC + StaticInfo.STAGE_SIZE_ANIMAL + StaticInfo.STAGE_SIZE_TRANSPORT;
