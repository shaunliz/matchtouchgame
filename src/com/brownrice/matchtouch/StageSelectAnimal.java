...
public class StageSelectAnimal extends Activity
{
...
//    public static AdRequest                         adRequest;
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        loadStage();
        cleared_stage_after_calc = cleared_stage - StaticInfo.STAGE_SIZE_EACH;
        ...
        setContentView(R.layout.stageselectanimal);
...
//        adView.loadAd(adRequest);
    ...
    {
        DM.i(this, " in updateClearedStage()   ][   cleared_stage_after_calc:" + cleared_stage_after_calc);
        ...
        for(int i = 0; i < cleared_stage_after_calc; i++)
        {
            ...
            stage_score = null;
            stage_time = "0";
            stage_time_to_dp = "00:00";
            
            // DM.i(this, "in updateClearedStage()   ][   for loop's i:" + i);
            imageView[i] = (ImageView)findViewById(R.id.stage_41 + i * 5);
            imageView[i].setImageResource(R.drawable.btn_stage_select_animal_each);
            
            textViewStage[i] = (TextView)findViewById(R.id.stage_text_41 + i * 5);
            textViewStage[i].setVisibility(View.VISIBLE);
            
            
            // display each stages score and time.
            textViewScore[i] = (TextView)findViewById(R.id.stage_score_41 + i * 5);
            textViewSec[i] = (TextView)findViewById(R.id.stage_sec_41 + i * 5);
            
            cur  = db.query("score", PROJECTION, "stage = " + "" + (i + 1 + StaticInfo.STAGE_SIZE_NUMERIC), null, null, null, null);
           ...
           //  DM.i(this, "2 score_time:" + stage_time);
            ...
            imageView[i].setOnClickListener(new View.OnClickListener()
            {
                ...
                public void onClick(View v)
                {
                    ...
                    {
                        if((R.id.stage_41 + nStage * 5) == v.getId())
                        {
                            requested_stage = nStage + StaticInfo.STAGE_SIZE_NUMERIC;
